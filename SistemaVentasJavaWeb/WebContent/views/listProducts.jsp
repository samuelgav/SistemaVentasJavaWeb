        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Productos <a href="${contextRoot}/PageController?ruta=insertProduct" class="btn bg-olive" id="btnagregar"><i class="fa fa-plus-circle"></i> Agregar</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
